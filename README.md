...
- Log: choose a week, fill one date for everyone, use Quick Fill or Bulk Fill, and expand one employee at a time.
...
Daily Log is the main supervisor workflow. Pick the date once, then fill that date for everyone from one compact list.

Daily Log can:

- Move to Previous day, Today, or Next day.
- Jump to any day in the selected week.
- Set everyone to Off, Half 5h, Full 10h, or a custom value.
- Set one person at a time with Off, Half 5h, Full 10h, +1, and -1.
- Open notes only when needed.
- Show how many employees are entered for that date.
...
Use Bulk Fill when several people worked the same hours.

1. Choose All people or Choose, then tick the people to update.
2. Choose Off 0h, Half day 5h, Full day 10h, or Custom.
3. Choose Today, an individual day, Weekdays, Weekend, or All week.
4. Tap Apply to selected people.

Example: choose 10 people, choose Full day 10h, choose Today, and apply. All selected people get 10 hours for today's day in the selected week.
